...
public class FileServlet extends DrEditServlet {
    ...
    public void doPut(HttpServletRequest req, HttpServletResponse resp)
        ...
        if (clientFile.content != null) {
            file = service.files().update(clientFile.resourceId, file,
            ...
            file = service.files()
                    .patch(clientFile.resourceId, file)
     ...
     * @throws java.io.IOException Thrown if the request fails for whatever reason.
     */
